package CursorHomeWorks06.IndexPage;
...
public class IndexController {
    ...
    public String indexPage(Model model) {
        model.addAttribute("title", "Lorem Ipsum")
                .addAttribute("about", "Cursor - Home Works 06 (Kiias Andrii)")
                .addAttribute("body", "Sed ut perspiciatis, unde omnis iste natus error sit" +
